          ...
          <!-- <div class="overflow-hidden z-10"> -->
            ...
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="{{ $product->productGalleries()->exists() ? Storage::url($product->productGalleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                  alt=""
