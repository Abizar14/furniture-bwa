<x-app-layout>
  <x-slot name="header">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
          Transaction &raquo; <span class="text-amber-700">{{ $item->name }}</span> &raquo; Edit
      </h2>
  </x-slot>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('dashboard.transaction.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
          @csrf
          @method('PUT')
