      ...
      <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
          <ul class="breadcrumb">
            ...
            <li>
              <a href="{{ route('dashboard.transaction.index') }}">Transactions</a>
            </li>
            <li>
              ...
              >
                <div class="px-4 flex-none">
                  <div class="" style="width: 90px; height: 90px">
                    <img
                      src="{{  $item->product->productGalleries()->exists() ? Storage::url($item->product->productGalleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                      alt="chair-1"
