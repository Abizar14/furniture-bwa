<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('dashboard.product.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
          @csrf
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">  
              <label for="desc" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Description</label>
              <textarea type="text" name="desc" placeholder="" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">{!! old('desc') !!}</textarea>
            </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-6"> 
            <div class="w-full px-3">
