    ...
    <section class="container mx-auto">
      <div class="flex flex-wrap my-4 md:my-12">
        ...
        <div class="flex-1">
          <div class="slider">
            <div class="thumbnail">
              @foreach ($products->productGalleries as $item)  
              <div class="px-2">
                <div
            ...
            <div class="preview">
              <div class="item rounded-lg h-full overflow-hidden">
                <img
                  src="{{ $products->productGalleries()->exists() ? Storage::url($products->productGalleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                  alt="front"
                  class="object-cover w-full h-full rounded-lg"
                />
              </div>
        ...
        <div class="flex-1 px-4 md:p-6">
          ...
          <form action="{{ route('cartAdd', $products->id) }}" method="POST">
            @csrf
            <button type="submit"
          ...
          <div class="px-3 flex-none" style="width: 320px"> 
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                src="{{ $recommendation->productGalleries()->exists() ? Storage::url($recommendation->productGalleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                alt=""
